import productsMaster from './products_master.json';
...
const mappedProducts: Product[] = productsMaster.products.map((item: any) => {
  ...
  return {
    ...
    seller: productsMaster.company_info.vruksha_composites.name,
    isSponsored: false
  };
});
